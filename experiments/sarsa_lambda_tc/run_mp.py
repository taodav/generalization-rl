...
if __name__ == "__main__":
    ...
    hyperparams = product(step_sizes, lambdas, tilings, tiles)

    for step_size, lam, tiling, tile in hyperparams:
        agent_hps = {
            'epsilon': 0.01,
            'step_size': step_size,
            'discount': 0.99,
    ...
    test_exp = GeneralizedMPExperiment(SarsaLambdaTCAgent, MountainCarEnv,
